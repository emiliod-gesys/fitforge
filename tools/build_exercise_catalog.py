...
LOCAL_IMAGE_OVERRIDES: dict[str, str] = {
    ...
    "ff_back_lat_pulldown_classic": "assets/exercises/ff_back_lat_pulldown_classic.png",
    "ff_back_v_bar_lat_pulldown": "assets/exercises/ff_back_v_bar_lat_pulldown.png",
    "ff_back_single_arm_lat_pulldown": "assets/exercises/ff_back_single_arm_lat_pulldown.png",
    "ff_back_cable_parallel_grip_lat_pulldown": "assets/exercises/ff_back_cable_parallel_grip_lat_pulldown.png",
    "ff_back_back_extension_machine": "assets/exercises/ff_back_back_extension_machine.png",
    "ff_abs_rotary_torso_machine": "assets/exercises/ff_abs_rotary_torso_machine.png",
    "ff_back_seated_row_machine": "assets/exercises/ff_back_seated_row_machine.png",
}
...
CATALOG_SUPPLEMENT = [
    ...
    {
        "group": "Back",
        "name_en": "Lat Pulldown Classic",
        "name_es": "Jalón clásico al pecho",
        "equipment": "Machine",
        "load_mode": "machine_stack",
        "per_arm_weight": False,
        "unilateral": False,
        ...
        "aliases_es": [
            "Lat Pulldown Classic",
            "Jalón al pecho clásico",
            "Jalón en polea alta",
        ],
        "aliases_en": [
            "Classic Lat Pulldown",
            "Lat Pulldown",
            "High Cable Lat Pulldown",
        ],
        "notes_es": "Jalón al pecho sentado con barra larga en polea alta.",
        "notes_en": "Seated lat pulldown using a long bar on a high pulley.",
    },
    {
        "group": "Back",
        "name_en": "V Bar Lat Pulldown",
        "name_es": "Jalón al pecho con barra V",
        "equipment": "Machine",
        "load_mode": "machine_stack",
        "per_arm_weight": False,
        "unilateral": False,
        ...
        "notes_es": "Jalón al pecho sentado usando accesorio de barra V en polea alta.",
        "notes_en": "Seated lat pulldown performed with a V-bar attachment on a high pulley.",
    },
    {
        "group": "Back",
        "name_en": "Single Arm Lat Pulldown",
        "name_es": "Jalón al pecho a una mano",
        "equipment": "Cable",
        ...
        "notes_es": "Jalón al pecho unilateral con manija en polea alta, sentado en banco.",
        "notes_en": "Unilateral lat pulldown using a single handle on a high cable, seated on a bench.",
    },
    {
        "group": "Back",
        "name_en": "Cable Parallel Grip Lat Pulldown",
        "name_es": "Jalón al pecho con agarre paralelo en polea",
        "equipment": "Cable",
        "load_mode": "single_load",
        "per_arm_weight": False,
        "unilateral": False,
        ...
        "aliases_es": [
            ...
            "Jalón arrodillado en poleas",
        ],
        "aliases_en": [
            "Parallel Grip Cable Lat Pulldown",
            "Kneeling Dual Cable Lat Pulldown",
            "Neutral Grip Cable Pulldown",
        ],
        "notes_es": "Jalón al pecho arrodillado con manijas en poleas altas y agarre paralelo.",
        "notes_en": "Kneeling lat pulldown using high cable handles with a parallel neutral grip.",
    },
    {
        "group": "Back",
        "name_en": "Back Extension Machine",
        "name_es": "Extensión lumbar en máquina",
        "equipment": "Machine",
        "load_mode": "machine_stack",
        "per_arm_weight": False,
        "unilateral": False,
        ...
        "notes_es": "Extensión de la columna lumbar sentado en máquina con torre de pesas.",
        "notes_en": "Seated lower-back extension on a selectorized machine.",
    },
    {
        "group": "Abs",
        "name_en": "Rotary Torso Machine",
        "name_es": "Oblicuos en máquina",
        "equipment": "Machine",
        "load_mode": "machine_stack",
        "per_arm_weight": False,
        "unilateral": False,
        ...
        "notes_es": "Rotación de torso sentado en máquina para trabajar oblicuos.",
        "notes_en": "Seated torso rotation on a selectorized machine targeting the obliques.",
    },
    {
        "group": "Back",
        "name_en": "Seated Row Machine",
        "name_es": "Remo sentado en máquina",
        "equipment": "Machine",
        "load_mode": "machine_stack",
        "per_arm_weight": False,
        "unilateral": False,
        ...
        "notes_es": "Remo horizontal sentado en máquina con pecho apoyado y agarre neutro.",
        "notes_en": "Seated horizontal row on a machine with chest support and neutral grip handles.",
    },
