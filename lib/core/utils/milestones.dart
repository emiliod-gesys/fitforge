...
abstract final class MilestonesCalculator {
  static const _definitions = {
    ...
    MilestoneCategory.reps: [
      MilestoneDefinition(tier: 1, threshold: 100),
      MilestoneDefinition(tier: 2, threshold: 500),
      MilestoneDefinition(tier: 3, threshold: 1000),
      MilestoneDefinition(tier: 4, threshold: 5000),
      MilestoneDefinition(tier: 5, threshold: 10000),
      MilestoneDefinition(tier: 6, threshold: 25000),
      MilestoneDefinition(tier: 7, threshold: 50000),
      MilestoneDefinition(tier: 8, threshold: 100000),
    ],
    MilestoneCategory.volume: [
      MilestoneDefinition(tier: 1, threshold: 1000),
      MilestoneDefinition(tier: 2, threshold: 5000),
      MilestoneDefinition(tier: 3, threshold: 10000),
      MilestoneDefinition(tier: 4, threshold: 25000),
      MilestoneDefinition(tier: 5, threshold: 50000),
      MilestoneDefinition(tier: 6, threshold: 100000),
    ...
    MilestoneCategory.distance: [
      ...
      MilestoneDefinition(tier: 2, threshold: 5000),
      MilestoneDefinition(tier: 3, threshold: 10000),
      MilestoneDefinition(tier: 4, threshold: 50000),
      MilestoneDefinition(tier: 5, threshold: 100000),
      MilestoneDefinition(tier: 6, threshold: 250000),
      MilestoneDefinition(tier: 7, threshold: 500000),
      MilestoneDefinition(tier: 8, threshold: 1000000),
    ],
    MilestoneCategory.calories: [
      ...
      MilestoneDefinition(tier: 4, threshold: 10000),
      MilestoneDefinition(tier: 5, threshold: 25000),
      MilestoneDefinition(tier: 6, threshold: 50000),
      MilestoneDefinition(tier: 7, threshold: 100000),
      MilestoneDefinition(tier: 8, threshold: 250000),
    ],
  };
