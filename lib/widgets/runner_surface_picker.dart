...
Future<RunningSurface?> showRunnerSurfacePicker(
  ...
  return showDialog<RunningSurface>(
    ...
    builder: (ctx) => SimpleDialog(
      title: Text(
        isWalk ? l10n.runnerWalkSurfaceTitle : l10n.runnerSurfaceTitle,
      ),
      children: [
        Padding(
          padding: const EdgeInsets.fromLTRB(24, 0, 24, 12),
          child: Text(
            isWalk ? l10n.runnerWalkSurfaceHint : l10n.runnerSurfaceHint,
