...
class AccentColorSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        if (_locked && lockedMessage != null) ...[
          Row(
            children: [
              Icon(Icons.lock_outline, size: 16, color: AppColors.textMuted.withValues(alpha: 0.8)),
          ...
          child: IgnorePointer(
            ...
            child: Wrap(
              ...
              children: AppAccent.values.map((accent) {
                ...
                return InkWell(
                  onTap: _locked ? null : () => onChanged!(accent),
                    ...
                    child: Column(
                      children: [
                        AnimatedContainer(
                          ...
                          child: isSelected
                              ? Icon(
                                  _locked ? Icons.lock : Icons.check,
                                  color: Colors.black,
                                  size: 20,
                                )
                              : null,
